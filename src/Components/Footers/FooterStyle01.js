                ...
                <Container>
                    <Row>
                        ...
                        <Col lg={3} sm={6} className="xs:mb-[25px]">
                            ...
                            <p className="w-[85%] mb-[15px]">36/1 Old Agraharam Street Thennur, Trichy India</p>
                            <div><i className="feather-phone-call text-sm mr-[10px] text-themecolor"></i>+91 7448427243</div>
                            <div><i className="feather-mail text-sm mr-[10px] text-themecolor"></i><a aria-label="mail" href="mailTo:admin@technology-garage.com">admin@technology-garage.com</a></div>
                        </Col>
                        <Col lg={3} sm={6}>
                ...
                <Container>
                    <Row>
                        ...
                        <Col md={6} className="flex justify-center items-center text-center sm:mb-[20px]">
                            <p className="mb-0">Copyright © 2022 - TechnologyGarage</p>
                        </Col>
