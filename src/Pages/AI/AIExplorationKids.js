              ...
              <Col className="col-12 col-lg-11">
                <m.div {...fadeIn} className="row">
                  ...
                  <Col lg={{ span: 7, offset: 1 }}>
                    <span className="font-serif text-md uppercase font-medium mb-[20px] inline-block text-darkgray">AI through Exploration </span>
                    <p className="mb-[25px] text-justify xs:text-left xs:mb-[15px]">
                    Welcome to the exciting world of Artificial Intelligence (AI)! AI is like a super-smart friend that helps make things easier and more fun. It's not just a fancy tool, it's like a magic wand that can do amazing things! With AI, boring stuff gets done faster, and we get to discover cool new ideas and games. It's like having a friendly robot buddy that makes life awesome! 
                    </p>
                    <p className="mb-[25px] text-justify xs:text-left xs:mb-[15px]">
                ...
                <Row className="items-center">
                  ...
                  <m.div className="col-12 col-md-6 col-xl-5 offset-xl-1" {...fadeInLeft}>
                    <Blockquote
                      ...
                      heading="Why technology garage for AI?"
                      title="Discover the Exciting World of Artificial Intelligence at Technology Garage: From Smart Solutions to Super Efficiency, Dive into Fun Learning to Become an AI Expert. Join Us to Ignite Your Tech Curiosity with Hands-On, Interactive, and Personalized Coaching for Everyone!"
                    />
                  </m.div>
                </Row>
              </Col>
                ...
                <Container>
                    <Row className="justify-between">
                        <m.div {...fadeIn} className="col-12 col-lg-4 col-md-7 col-sm-9 md:mb-[35px]">
                            <h6 className="font-serif text-darkgray font-medium m-0">Embark on an Adventure: Uncover the Boundless Potential of Artificial Intelligence Today!</h6>
                        </m.div>
                        <m.div {...{ ...fadeIn, transition: { delay: 0.5 } }} className="col-12 col-xl-3 col-lg-4 col-md-6 sm:mb-[30px]">
                            <div className="flex font-serif text-darkgray mb-[15px] font-medium"><span className="flex-shrink-0 self-center h-[1px] w-[40px] bg-[#ff6437] mr-[20px]"></span><div className="grow">The Challenges </div></div>
                            <p className="md:w-[80%] xs:w-full">Embrace the thrill of mastering artificial intelligence—an exciting voyage of creativity and exploration. Conquer hurdles, unleash possibilities, and leap onto the horizon of technology with resolve.</p>
                        </m.div>
                        <m.div {...{ ...fadeIn, transition: { delay: 0.6 } }} className="col-12 col-xl-3 col-lg-4 col-md-6">
                            ...
                            <p className="md:w-[80%] xs:w-full">Demystify artificial intelligence for newcomers with our simple approach: clear instructions and interactive learning to boost confidence and spark interest.</p>
                        </m.div>
                    </Row>
                </Container>
            </section>
...
export default AIExplorationKids;