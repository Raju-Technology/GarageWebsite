              ...
              <Col className="col-12 col-lg-11">
                <m.div {...fadeIn} className="row">
                  <Col lg={4} className="pr-[5%] lg:pr-[15px] md:mb-[50px]">
                    ...
                    Deep Learn and Machine Learning
                    </h5>
                    {/* <ul className="pl-0">
                  ...
                  <Col lg={{ span: 7, offset: 1 }}>
                    <span className="font-serif text-md uppercase font-medium mb-[20px] inline-block text-darkgray">Build - Your Own AI Creations</span>
                    <p className="mb-[25px] text-justify xs:text-left xs:mb-[15px]">
                    Dive into the fascinating realm of Deep Learning and Machine Learning, where you'll learn how computers can be taught to think and make decisions just like humans. It's like training your favorite robot to learn and become super-smart!.
                    </p>
                    <p className="mb-[25px] text-justify xs:text-left xs:mb-[15px]">
                    Welcome to the world of Deep Learning and Machine Learning, where computers are becoming smarter every day, opening endless possibilities for the future. Get ready to explore, learn, and maybe even build your own AI creations!    
                    </p>
                ...
                <Row className="items-center">
                  ...
                  <m.div className="col-12 col-md-6 col-xl-5 offset-xl-1" {...fadeInLeft}>
                    <Blockquote
                      ...
                      heading="Why technology garage for Deep learning and machine learning? "
                      title="At Technology Garage, we ignite passion for Deep Learning and Machine Learning in young minds, making it easy and fun to learn. From basics to advanced concepts, we offer a unique opportunity for kids to explore AI with confidence and enthusiasm. Join us to unleash your tech potential and embark on an incredible journey of discovery!"
                    />
                  </m.div>
                </Row>
              </Col>
                ...
                <Container>
                    <Row className="justify-between">
                        <m.div {...fadeIn} className="col-12 col-lg-4 col-md-7 col-sm-9 md:mb-[35px]">
                            <h6 className="font-serif text-darkgray font-medium m-0">Explore Deep Learning and Machine Learning: Create, Train & Consume, where clever machines turn the ordinary into extraordinary, guiding us to an exciting future! </h6>
                        </m.div>
                        <m.div {...{ ...fadeIn, transition: { delay: 0.5 } }} className="col-12 col-xl-3 col-lg-4 col-md-6 sm:mb-[30px]">
                            ...
                            <p className="md:w-[80%] xs:w-full">Embrace the exciting challenge of mastering Deep Learning and Machine Learning—a journey of discovery and innovation. Overcome obstacles, unlock your potential, and dive into the future of technology with determination. </p>
                        </m.div>
                        <m.div {...{ ...fadeIn, transition: { delay: 0.6 } }} className="col-12 col-xl-3 col-lg-4 col-md-6">
                            ...
                            <p className="md:w-[80%] xs:w-full">Deep Learning and Machine Learning for beginners with our simple approach: step-by-step guidance and fun hands-on learning to boost confidence and spark curiosity.</p>
                        </m.div>
                    </Row>
                </Container>
            </section>
