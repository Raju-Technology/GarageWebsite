              ...
              <Col className="col-12 col-lg-11">
                <m.div {...fadeIn} className="row">
                  ...
                  <Col lg={{ span: 7, offset: 1 }}>
                    <span className="font-serif text-md uppercase font-medium mb-[20px] inline-block text-darkgray">AI -Transforming Tomorrow</span>
                    <p className="mb-[25px] text-justify xs:text-left xs:mb-[15px]">
                    Enter the realm of Artificial Intelligence (AI), where innovation meets intelligence to redefine the boundaries of possibility. AI is not just a technology; it's a catalyst for transformative change across industries. From automating mundane tasks to unlocking new realms of creativity, AI is revolutionizing the way we work, live, and interact with the world around us.
                    </p>
