...
import RealTimeProjectsCoverImage from "../../Images/RoboticsRealTimeProjectsCoverImage.png"
import RoboticsGarageLogo from "../../Images/RoboticsGarageLogo1.png"
import RealTimeProjectSlider1 from "../../Images/RealTimeProjectSlider1.png"
import RealTimeProjectSlider2 from "../../Images/RealTimeProjectSlider2.png"
import RealTimeProjectSlider3 from "../../Images/RealTimeProjectSlider3.png"
import RealTimeProjectSlider4 from "../../Images/RealTimeProjectSlider4.png"
import RealTimeProjectSlider5 from "../../Images/RealTimeProjectSlider5.png"
import RealTimeProjectSquare from "../../Images/RealTimeProjectSquare.png"

//Data
const SwiperImgData = [
    {
      img: RealTimeProjectSlider1,
    },
    {
      img: RealTimeProjectSlider2,
    },
    {
      img: RealTimeProjectSlider3,
    },
    {
      img: RealTimeProjectSlider4,
    },
    {
      img: RealTimeProjectSlider5,
    }
  ];
    ...
    return (
      <div style={props.style}>
        ...
        <div className="h-[800px] md:h-[650px] sm:h-[350px] flex items-center overflow-hidden relative">
          <Parallax className="lg-no-parallax bg-cover cover-background absolute top-[0px] left-0 md:-top-[30px] w-full h-[100vh] md:h-[700px] sm:h-[400px] sm:-top-[60px]" translateY={[-40, 40]} style={{ backgroundImage: `url(${RealTimeProjectsCoverImage})` }}></Parallax>
            ...
            <Row className="h-full justify-center">
              <Col md={6} className="relative text-center flex flex-column justify-center">
                <span className="uppercase text-sm font-serif tracking-[5px] text-white inline-block mb-[20px] font-medium sm:mb-[10px]">
                  Robotics Real time Projects at
                </span>
              ...
              <Col className="col-12 col-lg-11">
                <m.div {...fadeIn} className="row">
                  <Col lg={4} className="pr-[5%] lg:pr-[15px] md:mb-[50px]">
                    ...
                    How does Technology Garage approach these projects?
                    </h5>
                    {/* <ul className="pl-0">
                  ...
                  <Col lg={{ span: 7, offset: 1 }}>
                    <span className="font-serif text-md uppercase font-medium mb-[20px] inline-block text-darkgray">Hands-On Learning at Technology Garage</span>
                    <p className="mb-[25px] text-justify xs:text-left xs:mb-[15px]">
                    At Technology Garage, we believe in providing a hands-on learning experience for our students. We guide them step-by-step through each project, ensuring they understand the concepts behind Arduino technology and how to apply it effectively. By encouraging experimentation and providing personalized coaching, we empower students to tackle real-world challenges with confidence.
                    </p>
              ...
              <Col lg={11} xs={12}>
                <Row className="items-center">
                  <m.div className="col-12 col-md-6 xs:mb-[30px]" {...fadeIn}>
                    <img height="" width="" src={RealTimeProjectSquare} alt="" />
                  </m.div>
                  <m.div className="col-12 col-md-6 col-xl-5 offset-xl-1" {...fadeInLeft}>
                    <Blockquote
                      className="xs:my-0"
                      theme="blockquote-style-02"
                      heading="Bringing Ideas to Life with Real-World Projects "
                      title="Embark on a journey of innovation as we delve into real-world Arduino projects, spanning from home automation to robotics. From controlling your home environment to building robotic creations, discover the endless possibilities and practical applications of Arduino technology. Let's dive in together and turn ideas into reality!"
                    />
                  </m.div>
                </Row>
              </Col>
                ...
                <Container>
                    <Row className="justify-between">
                        <m.div {...fadeIn} className="col-12 col-lg-4 col-md-7 col-sm-9 md:mb-[35px]">
                            <h6 className="font-serif text-darkgray font-medium m-0">Journey through Control Systems: Uncovering Real-World Project Power</h6>
                        </m.div>
                        <m.div {...{ ...fadeIn, transition: { delay: 0.5 } }} className="col-12 col-xl-3 col-lg-4 col-md-6 sm:mb-[30px]">
                            ...
                            <p className="md:w-[80%] xs:w-full">Embark on the exhilarating challenge of mastering Arduino: a journey filled with creativity and exploration. Embrace the obstacles as opportunities, and discover the limitless possibilities of technology with determination and perseverance.</p>
                        </m.div>
                        <m.div {...{ ...fadeIn, transition: { delay: 0.6 } }} className="col-12 col-xl-3 col-lg-4 col-md-6">
                            ...
                            <p className="md:w-[80%] xs:w-full">At Technology Garage, we demystify Arduino projects with a practical and engaging strategy. Through hands-on experimentation and personalized guidance, we simplify intricate concepts, enabling beginners to unleash their potential and immerse themselves in the world of Arduino with confidence and enthusiasm.</p>
                        </m.div>
                    </Row>
                </Container>
            </section>
