              ...
              <Col className="col-12 col-lg-11">
                <m.div {...fadeIn} className="row">
                  ...
                  <Col lg={{ span: 7, offset: 1 }}>
                    <span className="font-serif text-md uppercase font-medium mb-[20px] inline-block text-darkgray">Robotics – Innovating our world</span>
                    <p className="mb-[25px] text-justify xs:text-left xs:mb-[15px]">
                    Robotics, the fusion of innovation and precision, revolutionizes industries worldwide. From streamlining manufacturing processes to aiding surgeons in delicate procedures, robots redefine efficiency and safety. They cultivate crops with precision, construct with unparalleled accuracy, and venture into the depths of space, minimizing human risk. In defense, they surveil and defend, while at home, they assist with chores and even cook like master chefs. Robotics isn't just technology; it's a transformative force shaping our present and future..
                    </p>
