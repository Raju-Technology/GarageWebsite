              ...
              <Col xl={5} md={5} className="relative flex flex-col justify-center">
                ...
                <div className="font-serif cd-headline push">
                  <h3 className="heading-5 mb-0 text-darkgray font-serif">
                    <TextAnime color="#232323" duration={3000} className="font-bold text-darkgray uppercase text-[60px] leading-[95px] -tracking-[5px] sm:-tracking-[.5px] lg:text-[90px] lg:leading-[90px] md:text-[70px] md:leading-[65px] sm:text-[45px] sm:leading-[43px]" animation="push" data={["Browser", "Data", "System"]} />
                  </h3>
                  <h4 className="heading-5 mb-0 text-darkgray font-serif">
                    <TextAnime color="#232323" duration={3000} className="font-bold text-darkgray uppercase text-[60px] leading-[95px] -tracking-[5px] sm:-tracking-[.5px] lg:text-[90px] lg:leading-[90px] md:text-[70px] md:leading-[65px] sm:text-[45px] sm:leading-[43px]" animation="push" data={["Crafting", "Architecture", "Crafting"]} />
                  </h4>
                </div>
