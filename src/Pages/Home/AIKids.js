...
const PortfolioOverlayData = [
    ...
    },
    {
      ...
      category: [""],
      subtitle: "Using LLMs",
      link: "/AI/Kids/ApplicationUsingLLM"
    },
    {
      title: "Computer",
              ...
              <Col xl={5} md={5} className="relative flex flex-col justify-center">
                ...
                <div className="font-serif cd-headline push">
                  <h3 className="heading-5 mb-0 text-darkgray font-serif">
                    <TextAnime color="#232323" duration={3000} className="font-bold text-darkgray uppercase text-[60px] leading-[75px] -tracking-[5px] sm:-tracking-[.5px] lg:text-[90px] lg:leading-[80px] md:text-[70px] md:leading-[60px] sm:text-[30px] sm:leading-[28px]" animation="push" data={["Future", "Tech", "Code"]} />
                  </h3>
                  <h4 className="heading-5 mb-0 text-darkgray font-serif">
                    <TextAnime color="#232323" duration={3000} className="font-bold text-darkgray uppercase text-[60px] leading-[75px] -tracking-[5px] sm:-tracking-[.5px] lg:text-[90px] lg:leading-[80px] md:text-[70px] md:leading-[60px] sm:text-[30px] sm:leading-[28px]" animation="push" data={["Explorer", "Growth", "Companion"]} />
                  </h4>
                </div>
          ...
          <Container>
            <Row className=" align-center">
              <m.div className="col-lg-5 text-darkgray md:mb-[30px] text-left" {...fadeIn}>
                <h2 className="heading-6 font-serif leading-[40px] w-[90%] mb-0 lg:w-full sm:leading-[26px] xs:text-center">AI is like a superhero, making big changes everywhere! It helps with incredible stuff in all areas of life, making the world feel like a magical place where anything is &nbsp;
                  <span className="font-bold text-decoration-line-bottom-medium leading-[40px] whitespace-nowrap sm:leading-[26px]">possible!</span></h2>
              </m.div>
